...
\begin{table}
  \caption{Document and relevance labels in TREC web 2013 \& 2014.
...
\begin{table}[h]
\caption{A description of all content features provided with \datasetname1.}  
...
\end{tabular}
\caption{Three examples of the vanilla screenshot (left), red highlighted screenshot (center), and saliency heatmap (right).}
...
\begin{table}[h]
\caption{The number of documents with a screenshot from the Wayback Machine and from ClueWeb12, including their relevance score. (Note: This table is not up to date)} 
