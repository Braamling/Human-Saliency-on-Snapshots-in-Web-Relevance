...
\end{tabular}
\caption{Examples of a vanilla snapshot, a red highlighted snapshot, and saliency heatmap from left to right, respectively.}
...
\mdr{PageRank is not a content feature. }
In LTR, documents are ranked based on various content features, such as BM25 and PageRank.
We compute these content features by doing a full pass over the complete ClueWeb12 collection using Apache Spark.\footnote{\url{https://spark.apache.org/}}
\if0
