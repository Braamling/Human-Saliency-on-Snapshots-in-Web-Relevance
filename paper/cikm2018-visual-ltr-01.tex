...
the rendered web pages in the collection shared in~\citep{fan2017learning} come from the the GOV2 collection.\footnote{\url{http://ir.dcs.gla.ac.uk/test_collections/gov2-summary.htm}}
