...
Using eye-tracking, \citet{nielsen2006f} and \citet{pernice2017f} demonstrate how different design patterns \todo{what do you mean by design patterns?} influence the search patterns \todo{similarly, what do you mean by search patterns?} of various users.
Both studies show that organizing the content in certain shapes (i.e., an F-shape) increases the usability of a web page. \todo{How is usability related to search patters mentioned above?}
\citet{wang2014eye} also use eye-tracking to show that more complex websites \todo{complex in what sense?} have larger fixations areas, which increases the likelihood that the attention of a user is distracted.
