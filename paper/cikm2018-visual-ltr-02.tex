...
\citet{zhang2018relevance} propose a multimodel architecture for re-ranking \ac{SERPs} by learning visual patterns in the result snippits. Their work demonstrates the potential of exploring visual patterns to improve \ac{LTR} performance. 
