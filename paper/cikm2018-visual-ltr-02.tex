...
The work of \citet{fan2017learning} is limited by the GOV2 dataset, which lacks visual diversity, and by not using state-of-the-art visual feature extraction methods.
