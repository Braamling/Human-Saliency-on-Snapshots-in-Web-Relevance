...
Although VGG-16 produces higher average results than the baseline methods, it is not possible to prove the statistical significance for some RankBoost and LambdaMart results.
